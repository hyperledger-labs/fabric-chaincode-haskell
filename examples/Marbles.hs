...
import           Debug.Trace
import           GHC.Generics
import           Ledger.Queryresult.KvQueryResult
                                               as Pb
            ...
            case eeKv of
                ...
                Right kv ->
                    let
                        ...
                        makeKVString kv_ =
                            pack "Key: " <> TL.toStrict (Pb.kvKey kv_) <> pack ", Value: " <> TSE.decodeUtf8
                                (kvValue kv_)
                    in
...
parseMarble params =
    Marble { objectType = "marble", name = params !! 0, color = params !! 1, size = params !! 2, owner = params !! 3 }
